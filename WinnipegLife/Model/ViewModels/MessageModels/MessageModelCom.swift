...
class CommunityMessage: ObservableObject{
    ...
    private func checkDialogId() {
        if let user = UserManager.user{
            
            let url = baseUrl + "users/" + memberId + "?include=dialog"
            
//            let url = "https://media.lifewpg.ca/api/users/" + memberId + "?include=dialog"
            ...
            request.responseJSON{ [weak self] response in
                ...
                case .success(let value):
                    ...
                    let avatar = attributes["avatarUrl"]!.stringValue
...
//                    print(self.chatHistory)
    ...
    func sendNewMessage(_ msg:String) {
        guard let user = UserManager.user else { return }
        
        let url = baseUrl + "dialog"
        
//        let url = "https://media.lifewpg.ca/api/dialog"
        ...
        let request = makeRequest(url: url, type: "dialog/message", attributes: ["recipient_username": self.member.name, "message_text" : msg], headers: headers)
